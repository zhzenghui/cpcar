...
- (void) setupInternalData
{
    ...
    contentLabel.frame = CGRectMake(x, y+3, self.dataInternal.labelSize.width, self.dataInternal.labelSize.height);
    contentLabel.text = self.dataInternal.data.text;
    
    if (type == BubbleTypeSomeoneElse)
    {
        bubbleImage.image = [[UIImage imageNamed:@"message_Someone.png"] stretchableImageWithLeftCapWidth:21 topCapHeight:14];
        ...
        bubbleImage.image = [[UIImage imageNamed:@"message_bubbleMine.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:14];
        bubbleImage.frame = CGRectMake(x - 9, y - 4, self.dataInternal.labelSize.width + 26, self.dataInternal.labelSize.height + 15);
    }
//    else if (type == BubbleTypeSomeoneElseImage) {
//        bubbleImage.image = [[UIImage imageNamed:@"bubbleMine.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:14];
//        bubbleImage.frame = CGRectMake(x - 18, y - 4 , self.dataInternal.labelSize.width + 26, self.dataInternal.labelSize.height + 75);
//        
//        contentImageView.image = [UIImage imageNamed:@"qwe.png"] ;
//        contentImageView.frame = CGRectMake(x - 18, self.dataInternal.labelSize.height, 60, 50);
//        
//    }
//    else if (type == BubbleTypeMineImage) {
//     
//        bubbleImage.image = [[UIImage imageNamed:@"bubbleMine.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:14];
//        bubbleImage.frame = CGRectMake(x - 9, y - 4, self.dataInternal.labelSize.width + 26, self.dataInternal.labelSize.height + 75);
//        
//        
//        contentImageView.image = [UIImage imageNamed:@"qwe.png"] ;
//        contentImageView.frame = CGRectMake(x + 9, self.dataInternal.labelSize.height+20 , 60, 50);
//        
//    }
}
