...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    BOOL ret = [_mapManager start:@"C4DBA7EE97851EB2071111568535C6982EE61248" generalDelegate:nil];
    if (!ret) {
...
//    CustomNavigationBar *customNavBar = [[CustomNavigationBar alloc] initWithFrame:navC.navigationBar.frame];
//    
